...
app.post('/registerForMessageEvents', (req, res) => {
  ...
  let config = {
    username:'gdinesh1707@gmail.com', password: 'DineshKumar&DTech', apiURL: "https://dtech.zulipchat.com", realm: 'https://dtech.zulipchat.com'
  }
...
app.post('/longpoll', (req, res) => {
  ...
  data.append('username', 'gdinesh1707@gmail.com');
  data.append('password', 'DineshKumar&DTech');
